const userInfo = async (name, user, dobMonth, dobDay, dobYear, age, gender, phoneNumber, familyName, firstName, spouse, mother, father, siblings, town, city, province, university, universityGradYear, certification, certificationYear, occupation, occupationYears, occupation2, occupation2Years, skills, reference1, reference2, admin) => {
    try {
  ...
  if (userIntakeForm) {
    userIntakeForm.addEventListener('submit', e => {
      ...
      userInfo(name, user, dobMonth, dobDay, dobYear, age, gender, phoneNumber, familyName, firstName, spouse, mother, father, siblings, town, city, province, university, universityGradYear, certification, certificationYear, occupation, occupationYears, occupation2, occupation2Years, skills, reference1, reference2, admin);
    });
  }
